...
Docs: https://abdelkareemkobo.github.io/seootterschema_validator.html.md"""
...
def fetch_html(url: str,  # URL to fetch
    ...
    try:
        resp = httpx.get(url, headers={"User-Agent": "Mozilla/5.0 (compatible; seo-otter-schema-validator/1.0)"},
                         timeout=timeout)
