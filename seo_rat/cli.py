...
Docs: https://abdelkareemkobo.github.io/seo_ratcli.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/16_cli.ipynb.

# %% auto #0
__all__ = ['CONFIG_DIR', 'seo_rat_sync', 'load_mapper', 'seo_rat_report', 'seo_rat_audit', 'print_rankings', 'seo_rat_rank',
           'print_top_pages', 'seo_rat_top_pages', 'print_wins', 'seo_rat_wins', 'print_canob_keyword',
           'print_canob_groups', 'seo_rat_canob', 'fmt_date', 'print_index_check', 'print_index_report',
           'print_crawl_errors', 'seo_rat_index_check', 'seo_rat_index_report', 'seo_rat_crawl_errors',
           'seo_rat_index_refresh', 'print_trend', 'aggregate_by_period', 'seo_rat_trend', 'seo_rat_add_website',
           'seo_rat_list_websites', 'seo_rat_delete_website', 'print_comparison', 'seo_rat_compare',
           'print_country_breakdown', 'seo_rat_country_breakdown', 'print_schema_check', 'seo_rat_schema_check',
           'print_faq', 'seo_rat_faq']
...
def seo_rat_sync(
        ...
        secrets: str = str(Path.home() / ".config" / "seo_rat" / "client_secrets.json"),
...
from seo_rat.models import Website, add_or_update_website, get_all_websites, print_websites, delete_website, \
    GSCAnalytics
